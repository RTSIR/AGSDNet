...
To train the AGSDNet denoising network, first download the [UC Merced Land Use data](javascript:win3('UCMerced_LandUse.zip')) and copy the images into genData folder. Then generate the training data using:
