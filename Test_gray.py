...
parser.add_argument('--weightsPath',dest='weightsPath',type=str,default='./Pretrained_models/FLBGDNet_Gray.h5',help='pathOfTrainedCNN')
...
for i in range(0,lenth):
    ...
    cv2.imwrite("./Test_Results/Gray/"+str(i+1)+"_BGRRN_Gray.png",255.*z)
